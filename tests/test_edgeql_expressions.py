...
aa \
        ...
        for ops in [('=', '!='), ('?=', '?!=')]:
            ...
            for op in ops:
                ...
                await self.assert_query_result(
                    f'''
                        select range(-1, 2) {op}
                               range(-1, 2, inclow := true, inchigh := false);
                    ''',
                    [answer],
                )
                await self.assert_query_result(
            ...
            for op in ops:
                ...
                await self.assert_query_result(
                    f'''
                        select range(-1, 2) {op}
                               range(-1, 2, inclow := false, inchigh := true);
                    ''',
                    [answer],
                )
    ...
    async def test_edgeql_expr_range_03(self):
        ...
        await self.assert_query_result(
            r'''select range_get_upper(range(1, 5, inchigh := true));''',
            [6],
        )
        ...
        await self.assert_query_result(
            r'''select range_get_lower(range(1, 5, inclow := false));''',
            [2],
        )
    ...
    async def test_edgeql_expr_range_04(self):
        ...
        await self.assert_query_result(
            r'select range_is_inclusive_upper(range(1, 5, inchigh := true));',
        ...
        await self.assert_query_result(
            r'select range_is_inclusive_lower(range(1, 5, inclow := false));',
